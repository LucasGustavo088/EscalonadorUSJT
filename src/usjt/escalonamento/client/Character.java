 ...
 */
package usjt.escalonamento.client;
...
public class Character {
    ...
    public static void aboutSintax() {
        ...
        System.out.println("  java -jar Escalonador.jar usjt.escalonamento.client.Character processos algoritmo [preemptivo|quantum] ");
